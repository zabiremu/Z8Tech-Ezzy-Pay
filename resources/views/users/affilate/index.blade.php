                ...
                <x-users-data-table>
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Total_Member</th>
                            <th scope="col">Status</th>
                            <th scope="col">Rank</th>
                            <th scope="col">MFS Member</th>
                            <th scope="col">MFS Leader</th>
                            <th scope="col">MFS Manager</th>
                            <th scope="col">MFS Executive</th>
                            <th scope="col">MFS Director</th>
                            <th scope="col">MFS COE</th>
                            <th scope="col">MFS CEO</th>
                        </tr>
                    </thead>
                    <tbody id="tbody_data">
                        @foreach ($users as $item)
                            <tr>
                                ...
                                $member= App\Models\User::where('sponsor',$item->username)->count();
                                $totalMb1= App\Models\User::where('sponsor',$item->username)->where('rank' ,'MFS Member')->count();
                                 $totalMb2= App\Models\User::where('sponsor',$item->username)->where('rank', 'MFS Leader')->count();
                                  $totalMb3= App\Models\User::where('sponsor',$item->username)->where('rank', 'MFS Manager')->count();
                                   $totalMb4= App\Models\User::where('sponsor',$item->username)->where('rank', 'MFS Executive')->count();
                                    $totalMb5= App\Models\User::where('sponsor',$item->username)->where('rank', 'MFS Director')->count();
                                     $totalMb6= App\Models\User::where('sponsor',$item->username)->where('rank', 'MFS COE')->count();
                                      $totalMb7= App\Models\User::where('sponsor',$item->username)->where('rank', 'MFS CEO')->count();
                                ...
                                <th scope="col">{{ $totalMb1 }}</th>
                                <th scope="col">{{ $totalMb2 }}</th>
                                <th scope="col">{{ $totalMb3 }}</th>
                                <th scope="col">{{ $totalMb4 }}</th>
                                <th scope="col">{{ $totalMb5 }}</th>
                                <th scope="col">{{ $totalMb6 }}</th>
                                <th scope="col">
                                    {{ $totalMb7 }}
                                </th>
                                <th>
